...
namespace Fetch_top_200_stories_API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            {
                //DEV
                // c.SwaggerEndpoint("/swagger/v1/swagger.json", "Jio_AIVA_API");
            ...
            //  Connectionstring = Configuration["ConnectionStrings:DefaultConnection"];//Local
            //   Connectionstring = EncDec.Decrypt(Configuration["ConnectionStrings:DefaultConnection"]);//Prodution
